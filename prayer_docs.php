      ...
      <div class="row">
        <div class="col-md-12">
          <ol class="breadcrumb">
            ...
            <li class="active">Wednesday Prayers</li>
          </ol>
        </div>
      </div>
    </div>
...
<!-- Download Button -->
<a class="btn btn-default" href="./PrayerDocs/PRAYER IN PURSUIT OF RELATIONSHIP.pdf" download>Download Document <i class="fa fa-download"></i></a>
<br>
<br>
<br>
<br>
...
try {
    ...
    $sql = "SELECT file FROM prayer_docs ORDER BY id DESC LIMIT 1"; // Retrieve the document with the highest ID
...
<!-- <section>
<div>
<object data="./PrayerDocs/ESTABLISHING PRAYER AS A RHYTHM.pdf" type="application/pdf" width="100%" height="100%"></object>   
</div>
<br/>
<br/>
 -->
