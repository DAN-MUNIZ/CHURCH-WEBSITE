...
<!-- Download Button -->
<a class="btn btn-default" href="./COE/CALENDAR OF EVENTS MMC 2024.pdf" download="document.pdf">Download Document <i class="fa fa-download"></i></a>
<br>
<br>
...
try {
    ...
    $sql = "SELECT file FROM COE ORDER BY id DESC LIMIT 1"; // Retrieve the document with the highest ID
