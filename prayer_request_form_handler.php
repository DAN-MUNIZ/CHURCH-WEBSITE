...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $stmt = $conn->prepare("INSERT INTO p_requests (fname, lname, email, contact, request, anonymous, submitted) VALUES (:fname, :lname, :email, :contact, :request, :anonymous, :submitted)");
        ...
        $stmt->bindParam(':request', $request); // corrected variable name
