<?php include"header.php"; ?>
	<!-- //header-ends -->
			<div id="page-wrapper">
				<div class="graphs">
					<h3 class="blank1">All Prayer Requests</h3>
					 <div class="xs tabls">
					    ...
					    <thead>
                          ...
                          //include('../connect.php');
                            if(!isset($_GET["page"])){
                                ...
                                $tbl_name="p_requests";		//your table name
	...
	*/
        $get_p_requests_tbl = ORM::for_table("$tbl_name")
                 ->find_array();
         
	$total_pages = count($get_p_requests_tbl);
	...
	/* Get data. */
				...
				$result = $db->prepare("SELECT * FROM p_requests ORDER BY id DESC LIMIT $start, $limit");
				$result->execute();
