<?php include"header.php"; ?>
	<!-- //header-ends -->
			<div id="page-wrapper">
				<div class="graphs">
					<h3 class="blank1">All Service Sheets</h3>
					 <div class="xs tabls">
	...
	*/
	...
	/* Get data. */
				...
				$result = $db->prepare("SELECT * FROM service_sheets  ORDER BY id ASC LIMIT $start, $limit");
				$result->execute();
               ...
               ?> 
						  ...
						  <tr>
							  ...
							  <td>
								...
								<a href="delete-service_sheets.php?id=<?=$row['id'] ?>" class="fa fa-trash btn  btn-danger warning_4 delbtn"> Delete </a>
							 ...
							 <?php } ?>
							 <a href="add-service_sheets.php?>" class=" fa fa-map btn  btn-success delbtn"> Add Service sheet</a>
						</table>
						</div>
						</div>
				</div>
