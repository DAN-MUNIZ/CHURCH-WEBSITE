    ...
    <div id="content" class="content full">
      <div class="container">
        <div class="row">
          ...
          <a href="http://localhost/ackcathedralmombasayouths.org/program-detail.php?" download="program-detail.html" class="btn btn-default" data-placement="bottom" data-toggle="tooltip" data-original-title="Download Page"><i class="fa fa-download"></i></a>
          <a href="#contact" class="btn btn-default" data-placement="bottom" data-toggle="tooltip" data-original-title="Contact us"><i class="fa fa-phone"></i></a>
      ...
      <div class="btn-group">
   <a class="btn btn-default" href="events.php"><i class="">Back to events<<<</i></a>
    </div>	
    </br>
  </br>
                </div>
