...
<!-- Download Button -->
<a class="btn btn-default" href="./SermonDocs/WHY PRAISE HIM.pdf" download>Download Document <i class="fa fa-download"></i></a>
<br>
<br>
<br>
<br>
...
try {
    ...
    $sql = "SELECT file FROM sermon_docs WHERE id = 2";
