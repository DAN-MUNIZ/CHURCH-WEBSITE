      ...
      <div class="row">
        <div class="col-md-12">
          <ol class="breadcrumb">
            ...
            <li class="active">Thanksgiving Form</li>
          </ol>
        </div>
      </div>
    </div>
...
<div class="form-container">
    <form class="form" method="post" action="thanksgiving_form_handler.php">
        ...
        <label>
            <textarea required rows="5" placeholder="I'm Grateful Because:" class="requestbox" id="thanksgiving" name="thanksgiving"></textarea>
        </label>

        <label>
            <div class="checkbox-wrapper">
                <input type="checkbox" class="checkbox" id="anonymous" name="anonymous">
                <span style="color:white">Keep This Thanksgiving Anonymous</span>
            </div>
        </label>
