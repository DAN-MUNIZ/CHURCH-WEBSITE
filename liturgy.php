...
<!-- Download Button -->
<a class="btn btn-default" href="./liturgy/HolyCommunion2EDITEDAGAIN.pptx" download>Download Document <i class="fa fa-download"></i></a>
<br>
<br>
...
try {
    ...
    $sql = "SELECT file FROM liturgy ORDER BY id DESC LIMIT 1"; // Retrieve the document with the highest ID
    ...
    if ($row && isset($row['file'])) {
        ...
        $document_url = htmlspecialchars($row['file']); // Sanitize the URL

        // Display the document using an object tag
        echo "<object data='$document_url' type='application/vnd.openxmlformats-officedocument.presentationml.presentation' width='100%' height='500'></object>";
