...
<title>Service Program- Janani Luwum Youths</title>
      ...
      <div class="row">
        <div class="col-md-12">
          <ol class="breadcrumb">
            ...
            <li class="active">Service Program</li>
          </ol>
        </div>
      </div>
    </div>
...
<!-- Download Button -->
<a class="btn btn-default" href=" 	./service_sheets/22ND SEPTEMBER, 2024.pdf" download="YOUTH SUNDAY SERVICE PROGRAM 22ND SEPTEMBER, 2024.pdf ">DOWNLOAD SERVICE PROGRAM <i class="fa fa-download"></i></a>
<br>
<br>
...
try {
    ...
    $sql = "SELECT file FROM service_sheets ORDER BY id DESC LIMIT 1"; // Retrieve the document with the highest ID
    ...
    if ($row) {
        ...
        $document_url = $row['file'];
         ...
         // Convert the document URL to HTTPS if necessary
        $document_url = str_replace('http://', 'https://', $document_url);

        // Display the document using an embed tag
        echo "<embed src='$document_url' type='application/pdf' width='100%' height='100%'>";
