...
<title>Bible Study- Janani Luwum Youths</title>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-10 col-sm-10 col-xs-8">
          <h1>BIBLE STUDIES SERIES TEACHINGS</h1>
        </div>
...
<!-- Download Button -->
<a class="btn btn-default" href="./BibleStudy/THEJOYOFSINGLEHOOD.pdf" download>Download Document <i class="fa fa-download"></i></a>
<br>
<br>
<br>
<br>
...
try {
    ...
    $sql = "SELECT file FROM bible_study ORDER BY id DESC LIMIT 1"; // Retrieve the document with the highest ID
